...
export const signupSchema = yup.object().shape({
	...
	password: yup.string().min(6).matches(validPassword, { message: "Minimum of 6 characters. Must contain 1 uppercase, 1 lowercase and 1 number" }).required("Password is required"),
});