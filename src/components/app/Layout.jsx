...
const Layout = () => {
	...
	const sidebarStyle = "md:w-80 w-40 sticky left-0 top-0 border border-0 border-r border-slate-200 bg-cyan-50 h-screen md:overflow-hidden overflow-auto md:hover:overflow-auto pb-10"
			...
			<div className="flex">
				<div>
					...
					<div className={`${sidebarStyle} ${!sidebar ? "hidden" : !mobile ? handleMobile() : sidebarStyle}` }>
						<div className="flex justify-center items-center px-4 border border-0 border-b border-slate-200">
				...
				<div className="grow">
					{/*Navbar*/}
					<nav className="flex justify-between h-20 border border-0 border-b border-slate-200 sticky top-0 z-10 bg-white">
