					...
					<div className="flex">
						<div className="flex-1">
							<div
								...
								<div>
									<button className="xl:p-2 md:text-lg text-sm mx-2 p-2"
													onClick={() => navigate(`/appointments/bookappointmentbyadmin/${beneficiaryDetails.id}`)}>Book
										Appointment
									</button>
								</div>
							...
							<div className="my-10 ml-5 text-gray-600 lg:text-xl">
								...
								<div className="grid grid-cols-4">
									...
									<p className="py-5 md:ml-5 md:col-start-2 col-span-2">{loading ?
										<Shimmer/> : beneficiaryDetails ? getDate(beneficiaryDetails?.dob) : ""} </p>
								</div>
								<div className="grid grid-cols-4">
