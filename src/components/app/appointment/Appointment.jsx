				...
				<div className="lg:px-20 lg:py-4 md:px-10 p-3">
					...
					<div className="xs:flex-col justify-center md:flex items-center md:justify-between my-5 lg:mt-10">
						...
						<div className="space-x-2">
							<button className="py-3 md:px-4 px-2 text-sm"
											onClick={() => navigate('/appointments/bookappointment')}>Book Appointment
							</button>
							<button className="py-3 md:px-4 px-2 text-sm"
											onClick={() => navigate('/beneficiaries/addbeneficiary')}>Add Beneficiary
							</button>
						</div>
					</div>
