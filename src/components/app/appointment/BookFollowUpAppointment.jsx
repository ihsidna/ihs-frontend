		...
		<HelmetProvider>
			<>
				...
				<div className="lg:p-20 md:p-10 p-3">
					...
					<button className="flex flex-row items-center justify-start h-10 border-0 bg-transparent text-slate-500 md:mt-14 md:mb-4 mt-20 mb-4" onClick={() => navigate("/allappointments")}>
