...
const BookAppointment = () => {
	...
	return (
		...
		// 	<button className="flex h-10 border-0 bg-transparent text-slate-500 md:mb-20 md:mt-0 my-8" onClick={() => navigate("/appointments")}>
		...
		//
		// 				{/*Date and Time*/}
		// 				<div className="flex pt-10 md:flex-nowrap flex-wrap">
		// 					<div>
