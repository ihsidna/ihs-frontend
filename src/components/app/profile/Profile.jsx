					...
					<div className="lg:px-20 lg:py-4 md:px-10 p-3">
						...
						<div className="flex-1">
							...
							<div className="my-10 md:ml-5 text-gray-600 md:text-xl text-md">
								...
								<div className="grid grid-cols-5">
									<button className="py-5 col-start-1 col-span-2 text-ihs-green bg-transparent border-0 text-start"
						...
						<input
							...
							className={` ${errors.confirmPassword && touched.confirmPassword ? 'focus:ring-red-600' : 'focus:ring-ihs-green-shade-600'} sm:w-96 w-72 border border-gray-300 px-3 py-3 text-gray-500 rounded-md focus:outline-none focus:ring-1`}/>
								{revealConfirmPwd ?
									...
									:
									<EyeIcon className="w-4 -ml-6 text-gray-500"
													 onClick={() => setRevealConfirmPwd(prevState => !prevState)}/>
								}
					</span>
							{errors.confirmPassword && touched.confirmPassword &&
								<p className="text-red-500 normal-case text-xs mt-2">{errors.confirmPassword}</p>}
