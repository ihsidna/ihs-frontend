			...
			<div className="max-w-[1240] mx-auto">
				...
				<div className="grid md:grid-cols-3 gap-4 text-center my-10 md:mx-20 mx-10">
					...
					<div className="bg-white shadow py-5 flex flex-col justify-center items-center">
						...
						<p className="text-gray-400 font-thin text-sm">Abuja, Nigeria</p>
					</div>
					...
					<div className="bg-white shadow py-5 flex flex-col justify-center items-center">
						<p className="text-gray-700">Eko Hospital</p>
						<p className="text-gray-400 font-thin text-sm">Lagos, Nigeria</p>
					</div>
					...
					<div className="bg-white shadow py-5 flex flex-col justify-center items-center">
						<p className="text-gray-700">St. Luke's Hospital</p>
						<p className="text-gray-400 font-thin text-sm">Delta, Nigeria</p>
					</div>

					<div className="bg-white shadow py-5 flex flex-col justify-center items-center">
						<p className="text-gray-700">St. Catherine of Siena Hospitals</p>
						<p className="text-gray-400 font-thin text-sm">Ebonyi, Nigeria</p>
					</div>
					...
					<div className="bg-white shadow py-5 flex flex-col justify-center items-center">
						<p className="text-gray-700">Mercy Hospital</p>
