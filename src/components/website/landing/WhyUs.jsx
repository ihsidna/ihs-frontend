...
const WhyUs = () => {
	...
	return (
		<div className="lg:mt-20 py-32 mx-10">
				...
				<div className="grid md:grid-cols-2">
					...
					<div className="grid md:grid-cols-2 mt-2 sm:hidden">
					...
					<div className="w-full px-8 py-8 md:order-first md:mt-40 lg:mt-0 hidden sm:inline">
