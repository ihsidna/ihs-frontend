						...
						<div className="grid lg:grid-cols-3 md:grid-cols-2">
							<div className="shadow-md mx-2 my-6 bg-white">
								...
								<div className="bg-white md:py-10 py-8 -mt-1 rounded-b-lg px-2 px-2">
									<div className="grid grid-cols-12 items-center space-x-4">
										<TruckIcon className="col-span-2 bg-ihs-green text-white rounded-md md:w-12 xl:w-16 p-1"/>
										<p className="col-span-10 font-normal text-xl md:text-2xl">Ambulance & Evacuation Services</p>
									</div>
								</div>
							</div>
							<div className="shadow-md mx-4 my-6 bg-white">
								...
								<div className="bg-white md:py-10 py-8 -mt-1 rounded-b-lg px-2">
									<div className="grid grid-cols-12 items-center space-x-4">
										<OfficeBuildingIcon className="col-span-2 bg-ihs-green text-white rounded-md md:w-12 xl:w-16 p-1"/>
										<p className="col-span-10 font-normal text-xl md:text-2xl">A&E, Resuscitative Treatments & ICU Access</p>
									</div>
								</div>
							</div>
							<div className="shadow-md mx-4 my-6 bg-white">
								...
								<div className="bg-white md:py-10 py-8 -mt-1 rounded-b-lg px-2">
									<div className="grid grid-cols-12 items-center space-x-4">
										<LightningBoltIcon className="col-span-2 bg-ihs-green text-white rounded-md md:w-12 xl:w-16 p-1"/>
										<p className="col-span-10 font-normal text-xl md:text-2xl">Oncology & Dialysis Care</p>
									</div>
								</div>
							</div>
							<div className="shadow-md mx-4 my-6 bg-white">
								...
								<div className="bg-white md:py-10 py-8 -mt-1 rounded-b-lg px-2">
									<div className="grid grid-cols-12 items-center space-x-4">
										<FolderOpenIcon className="col-span-2 bg-ihs-green text-white rounded-md md:w-12 xl:w-16 p-1"/>
										<p className="col-span-10 font-normal text-xl md:text-2xl">Specialists Consultations</p>
									</div>
								</div>
							</div>
							<div className="shadow-md mx-4 my-6 bg-white">
								...
								<div className="bg-white md:py-10 py-8 -mt-1 rounded-b-lg px-2">
									<div className="grid grid-cols-12 items-center space-x-4">
										<ScissorsIcon className="col-span-2 bg-ihs-green text-white rounded-md md:w-12 xl:w-16 p-1"/>
										<p className="col-span-10 font-normal text-xl md:text-2xl">Intermediate & Major Surgeries</p>
									</div>
								</div>
							</div>
							<div className="shadow-md mx-4 my-6 bg-white">
								...
								<div className="bg-white md:py-10 py-8 -mt-1 rounded-b-lg px-2">
									<div className="grid grid-cols-12 items-center space-x-4">
										<StopIcon className="col-span-2 bg-ihs-green text-white rounded-md md:w-12 xl:w-16 p-1"/>
										<p className="col-span-10 font-normal text-xl md:text-2xl">Custom Care</p>
									</div>
								</div>
							</div>
						</div>
