							...
							<div className="shadow-md mx-2 my-6">
								...
								<div className="bg-white md:py-10 py-8 -mt-1 rounded-b-lg px-2">
									<div className="grid grid-cols-12 items-center space-x-4">
										<CubeIcon className="col-span-2 bg-ihs-blue text-white rounded-md md:w-12 xl:w-16 p-1"/>
										<p className="col-span-10 font-normal text-xl md:text-2xl">Routine Health Checks & Monitoring</p>
									</div>
								</div>
							</div>
							<div className="shadow-md mx-2 my-6">
								...
								<div className="bg-white md:py-10 py-8 -mt-1 rounded-b-lg px-2">
									<div className="grid grid-cols-12 items-center space-x-4">
										<BeakerIcon className="col-span-2 bg-ihs-blue text-white rounded-md md:w-12 xl:w-16 p-1"/>
										<p className="col-span-10 font-normal text-xl md:text-2xl">Medication Administration</p>
									</div>
								</div>
							</div>
							<div className="shadow-md mx-2 my-6">
								...
								<div className="bg-white md:py-10 py-8 -mt-1 rounded-b-lg px-2">
									<div className="grid grid-cols-12 items-center space-x-4">
										<HeartIcon className="col-span-2 bg-ihs-blue text-white rounded-md md:w-12 xl:w-16 p-1"/>
										<p className="col-span-10 font-normal text-xl md:text-2xl">Post-Op & Ambulatory Care</p>
									</div>
								</div>
							</div>
							<div className="shadow-md mx-2 my-6">
								...
								<div className="bg-white md:py-10 py-8 -mt-1 rounded-b-lg px-2">
									<div className="grid grid-cols-12 items-center space-x-4">
										<ClipboardIcon className="col-span-2 bg-ihs-blue text-white rounded-md md:w-12 xl:w-16 p-1"/>
										<p className="col-span-10 font-normal text-xl md:text-2xl">Healthcare Coordination & Administration</p>
									</div>
								</div>
							</div>
							<div className="shadow-md mx-2 my-6">
								...
								<div className="bg-white md:py-10 py-8 -mt-1 rounded-b-lg px-2">
									<div className="grid grid-cols-12 items-center space-x-4">
										<SupportIcon className="col-span-2 bg-ihs-blue text-white rounded-md md:w-12 xl:w-16 p-1"/>
										<p className="col-span-10 font-normal text-xl md:text-2xl">Coaching & Literacy Support</p>
									</div>
								</div>
							</div>
							<div className="shadow-md mx-2 my-6">
								...
								<div className="bg-white md:py-10 py-8 -mt-1 rounded-b-lg px-2">
									<div className="grid grid-cols-12 items-center space-x-4">
										<StopIcon className="col-span-2 bg-ihs-blue text-white rounded-md md:w-12 xl:w-16 p-1"/>
