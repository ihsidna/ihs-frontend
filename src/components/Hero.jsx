		...
		<div className="w-full bg-white flex flex-col justify-between sm:pt-32 pt-32 md:pb-20 pb-20 md:px-10">
			<div className="grid md:grid-cols-2 max-w-[1240] mx-auto">
				<div className="flex flex-col justify-center md:items-start items-center w-full px-8 py-5">
					<h1 className="lg:text-6xl md:text-4xl text-3xl md:py-2 sm:py-2 py-1 font-bold text-gray-800">Home health care</h1>
					<h1 className="lg:text-6xl md:text-4xl text-3xl md:py-2 sm:py-2 py-1 font-bold text-gray-800 "> for your Loved Ones</h1>
					<h1 className="lg:text-6xl md:text-4xl text-3xl md:py-2 sm:py-2 py-1 font-bold text-gray-800">At Home</h1>
