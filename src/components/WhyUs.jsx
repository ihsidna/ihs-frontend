		...
		<div className="w-full lg:mt-20 lg:pt-20 py-32">
				...
				<div className="grid md:grid-cols-2 content-evenly md:mx-20">
					...
					<div className="flex flex-col justify-center lg:px-10 md:px-10 px-8">
						<h2 className="md:text-6xl text-4xl font-bold pb-10 text-gray-800 underline underline-offset-4 decoration-wavy decoration-ihs-green decoration-2 ">Why IHS?</h2>
						...
						<div className="grid md:grid-cols-2 my-8 lg:w-full md:w-full">
							<button className="bg-ihs-green md:py-4 py-4 my-4 md:px-4 px-4 md:mr-4 md:text-xl text-xl md:hover:bg-transparent md:hover:text-ihs-green md:hover:border-ihs-green md:hover:font-bold hover:bg-transparent hover:text-ihs-green hover:border-ihs-green hover:font-bold shadow-2xl">Create an account</button>

							<button className="bg-ihs-blue md:py-4 py-4 my-4 md:px-4 px-4 md:mr-4 md:text-xl text-xl md:hover:bg-transparent md:hover:text-ihs-blue md:hover:border-ihs-blue md:hover:font-bold hover:bg-transparent hover:text-ihs-blue hover:border-ihs-blue hover:font-bold shadow-2xl">Learn More</button>
						</div>
					</div>
