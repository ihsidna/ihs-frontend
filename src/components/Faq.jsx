			...
			<div className="md:py-40 pb-20 pt-8">
				<div className="max-w-[1240] mx-auto">
					<div className="flex justify-center items-start">
						<h2 className="md:text-3xl text-2xl font-semibold pb-2 mb-10 text-gray-800 border-b-2 border-b-ihs-green rounded-lg">
							About IHS
						</h2>
					</div>
					...
					<div className="flex justify-center items-start">
						<h2 className="mt-10 md:text-3xl text-2xl font-semibold pb-2 mb-10 text-gray-800 border-b-2 border-b-ihs-green rounded-lg">
							Beneficiaries
						</h2>
					</div>
					<div className="lg:px-80 md:px-40 px-10 ">
